...
def extract_answer(pred_str, data_name, use_last_number=True):
    ...
    if data_name in ["mmlu_stem", "sat_math", "aqua", "gaokao2023", "gpqa_d", "gpqa_d_debug"]:
...
def parse_ground_truth(example: Dict[str, Any], data_name):
    ...
    if data_name in ["math", "minerva_math", "math500"]:
        ...
        gt_cot, gt_ans = None, example["answer"]
    elif data_name in ["deepmath"]:
        gt_cot = None
        gt_ans = example["final_answer"]
    elif data_name in ["gpqa_d", "gpqa_d_debug"]:
        gt_cot = None
        gt_ans = example["answer"]
    else:
